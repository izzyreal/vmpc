...
MouseUpHandler::MouseUpHandler(mpc::Mpc* _mpc, Gui* _gui) : mpc(_mpc), gui(_gui)
{
}
...
void MouseUpHandler::handle(const SDL_MouseButtonEvent& event) {
